...
customGenerator.forBlock['sfdigital_write'] = function(block: Blockly.Block){
...
customGenerator.forBlock['sfanalog_write'] = function(block: Blockly.Block){
  const pin = block.getFieldValue('pin');
  //const value = block.getFieldValue('value');
...
customGenerator.forBlock['sfpinmode'] = function(block: Blockly.Block){
