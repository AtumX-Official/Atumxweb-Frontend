...
customGenerator.forBlock['cayodigital_write'] = function(block: Blockly.Block){
...
customGenerator.forBlock['cayoanalog_write'] = function(block: Blockly.Block){
  const pin = block.getFieldValue('pin');
  //const value = block.getFieldValue('value');
...
customGenerator.forBlock['cayopinmode'] = function(block: Blockly.Block){
