...
customGenerator.forBlock['stemrobodigital_write'] = function(block: Blockly.Block){
...
customGenerator.forBlock['stemroboanalog_write'] = function(block: Blockly.Block){
  const pin = block.getFieldValue('pin');
  //const value = block.getFieldValue('value');
...
customGenerator.forBlock['stemrobopinmode'] = function(block: Blockly.Block){
