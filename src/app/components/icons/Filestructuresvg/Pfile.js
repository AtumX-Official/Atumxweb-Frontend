...
const SvgPfile = (props) => (
  ...
  >
    ...
    <rect width={10} height={4} x={31.5} y={25} fill="#2195FF" rx={2} />
    ...
    />
    <rect width={26} height={4} x={15.5} y={33} fill="#FFDE21" rx={2} />
    <rect
      width={20}
      height={4}
      fill="#000"
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_7059_25042"
        />
        <feBlend
          in="SourceGraphic"
          in2="effect1_dropShadow_7059_25042"
          result="shape"
        />
      </filter>
    </defs>
