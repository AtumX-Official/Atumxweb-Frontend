...
const SearchallPanel = ({
  ...
  return (
    <div className="text-black text-sm flex flex-col gap-2">
      <div className="w-[250px] h-full rounded-md bg-white dark:bg-[#272727] custom-scrollbar flex flex-col">

        <div className="w-full h-[35px] flex items-center px-4 font-bold">
          <div className="flex items-center gap-2">
            <MdSearch className="w-5 h-5" />
            <span className="text-lg text-black dark:text-white">Search</span>
          </div>
        </div>
