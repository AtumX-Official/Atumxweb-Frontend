...
export function ExplorerNode({
  ...
  const rowBgClass = isRenaming
  ? language === "python"
    ? "bg-[#561DBC] text-white ring-2 ring-yellow-300"
    : `${isDark ? "bg-red-800 text-white" : "bg-red-200 text-black"} ring-2 ring-yellow-300`

  : isOpenFolder
    ? "bg-[#722CF0] text-white"

  : isInsideOpenFolder
    ? `${isDark ? "bg-black text-white" : "bg-[#EAEAEA] text-black"}`

  : isSelected
    ? language === "python"
      ? `${isDark ? "bg-[#561DBC]" : "bg-[#722CF0]"} text-white`
      : `${isDark ? "bg-red-700 text-white" : "bg-red-300 text-black"}`

  : language === "python"
    ? `${isDark ? "bg-[#561DBC] text-purple-100" : "bg-[#722CF0] text-white"}`
    : `${isDark 
        ? "bg-red-900/40 hover:bg-red-800 text-red-100" 
          ...
          >
            ...
            <div
              onClick={() => {
                ...
                console.log("ExplorerNode navigate firing");
              ...
              <div className="flex items-center gap-2 overflow-hidden flex-1 min-w-0">
                ...
                {isRenaming ? (
                  <input
                    ...
                    className={`flex-1 min-w-0 text-sm px-1.5 py-0.5 rounded border-2 border-yellow-300 outline-none font-normal truncate
                ...
                {isCreatingFile && (
                  <li className="list-none">
                    <div className="h-9 px-2 rounded flex items-center gap-2 bg-[#561DBC] ring-2 ring-yellow-300">
                      <img src={fileicon} className="w-5 h-5 shrink-0" />
